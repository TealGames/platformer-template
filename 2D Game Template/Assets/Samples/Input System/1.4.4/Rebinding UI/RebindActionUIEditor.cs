...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_OverrideActionTextProperty= serializedObject.FindProperty("m_OverrideActionText");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_OverrideActionTextProperty);
        ...
        private SerializedProperty m_OverrideActionTextProperty;
